...
# with command line options: step4 -s HARVESTING:validationHarvestingNoHLT+dqmHarvestingFakeHLT --conditions auto:run1_mc --mc --filetype DQM --scenario pp -n 100 --filein file:step3_inDQM.root --fileout file:step4.root
...
# Schedule definition
process.schedule = cms.Schedule(process.validationHarvestingNoHLT,process.dqmHarvestingFakeHLT,process.dqmsave_step)
